...
//player start
if (prev == 1){$('#40').append('<div id=\"player\"></div>');}
else if (prev == 5){$('#40').append('<div id=\"player\"></div>');}
//player end
if (prev == 1){$('#49').addClass('end').addClass('3w'); $('#95').addClass('end').addClass('3s');}
else if (prev == 5){$('#49').addClass('end').addClass('3w'); $('#95').addClass('end').addClass('3s');}
//enemies
//NPCs
//objects
//hp
...
$( "#22" ).css( "background-color", yellow).addClass("yellow");				
$( "#23" ).css( "background-color", yellow).addClass("yellow");				
...
$( "#99" ).css( "background-color", blue).addClass("blue");															var haveKey = $(".bag").find("#LavaKey").length;
        if (haveKey >= 1){
$( "#63" ).css( "background-color", lava).addClass("land");
...
$( "#83" ).css( "background-color", lava).addClass("land");
$( "#87" ).css( "background-color", lava).addClass("land");	
        }																					else {
$( "#63" ).css( "background-color", lava).addClass("lava");
...
$( "#83" ).css( "background-color", lava).addClass("lava");
$( "#87" ).css( "background-color", lava).addClass("lava");		
        }																																																							
